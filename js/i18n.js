...
const TRANSLATIONS = {
  az: {
    ...
    timer_minutes: "dəq",
    timer_seconds: "san",
    featured_title: "Ən sərfəli təkliflər",
    ...
    zoom_image: "Şəkli böyüt",
    sort_label: "Sırala:",
    sort_default: "Defolt",
    sort_price_asc: "Qiymət: azdan çoxa",
    sort_price_desc: "Qiymət: çoxdan aza",
    cart_title: "Səbət",
    cart_add: "Səbətə əlavə et",
    cart_added: "Məhsul səbətə əlavə olundu",
    cart_empty: "Səbətiniz boşdur",
    cart_total: "Cəmi",
    cart_clear: "Səbəti boşalt",
    cart_checkout_whatsapp: "WhatsApp ilə sifariş et",
    cart_wa_greeting: "Salam! Sifariş vermək istəyirəm:",
  },
  en: {
    nav_catalog: "Catalog",
    nav_contact: "Contact",
    ...
    cart_checkout_whatsapp: "Order via WhatsApp",
    cart_wa_greeting: "Hi! I'd like to order:",
  },
  ru: {
    nav_catalog: "Каталог",
    nav_contact: "Контакт",
    ...
    timer_minutes: "мин",
    timer_seconds: "сек",
    featured_title: "Лучшие предложения",
    ...
    cart_checkout_whatsapp: "Заказать через WhatsApp",
    cart_wa_greeting: "Здравствуйте! Хочу сделать заказ:",
  },
};
